...
export default function Reembolso1() {
  return (
    <>
      <Head title="Reembolso" />
        ...
        <div className="w-full max-w-md bg-white rounded-2xl p-6 shadow-lg text-center">
          ...
          <div className="mt-4">
            ...
            <p className="text-sm text-gray-600 mt-2">
              Você deseja reembolsar Isabella Almeida Soares no valor de R$ 350,00?
            </p>

            <button
              className="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-md"
              onClick={() => router.visit('/reembolso2')}
            >
              SIM
            </button>
          </div>
